# genpark-crowdsourced-gig-fleet-multimodal-logistics-skill
...
> **GenPark AI Agent Skill** -- Crowdsourced gig fleet and multi-modal express logistics platform (Shadowfax style)
